# Projetos de ciência de dados — Mentorama

Implementações próprias baseadas nos enunciados do curso. Os dados de terceiros e os
materiais didáticos não são redistribuídos neste repositório.
...
**Critério de publicação:** cada resultado de modelo deve trazer origem dos dados,
